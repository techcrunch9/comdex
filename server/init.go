...
func InitCmd(ctx *Context, cdc *wire.Codec, appInit AppInit) *cobra.Command {
	...
	cmd.Flags().BoolP(flagOverwrite, "o", true, "overwrite the genesis.json file")
	cmd.Flags().String(flagChainID, "comdex-hub", "genesis file chain-id, if left blank will be randomly created")
