...
type IssueAsset struct {
	IssuerAddress  sdk.Address        `json:"issuerAddress"`
	ToAddress      sdk.Address        `json:"toAddress"`
	AssetPegWallet sdk.AssetPegWallet `json:"assetPegWallet"`
}

//NewIssueAsset : initializer
func NewIssueAsset(issuerAddress sdk.Address, toAddress sdk.Address, assetPegWallet sdk.AssetPegWallet) IssueAsset {
	return IssueAsset{issuerAddress, toAddress, assetPegWallet}
}
...
func (in IssueAsset) GetSignBytes() []byte {
	bin, err := msgCdc.MarshalJSON(struct {
		...
		IssuerAddress:  sdk.MustBech32ifyAcc(in.IssuerAddress),
		ToAddress:      sdk.MustBech32ifyAcc(in.ToAddress),
		AssetPegWallet: in.AssetPegWallet,
	})
	if err != nil {
		panic(err)
	}
...
//Type : implements msg
func (msg MsgIssueAssets) Type() string { return "bank" }

//ValidateBasic : implements msg
func (msg MsgIssueAssets) ValidateBasic() sdk.Error { return nil }
...
func (msg MsgIssueAssets) GetSigners() []sdk.Address {
	addrs := make([]sdk.Address, len(msg.IssueAssets))
